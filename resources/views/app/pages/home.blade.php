    ...
    <div class="p-4 bg-white block sm:flex items-center justify-between border-gray-200 lg:mt-1.5 dark:bg-gray-900 dark:border-gray-700">
        <div class="w-full mb-1 mb-4">
            ...
            <div class="px-4 pt-6 2xl:px-0">
                ...
                {{-- CONTENT 1 --}}
                <div class="grid gap-4 xl:grid-cols-2 2xl:grid-cols-3" style="border: red 1px solid;">

                    {{-- CARD 1 --}}
                    <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800" style="border: red 1px solid;">
                        ...
                        <div class="max-w-2xl overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
                            ...
                            <div class="p-6">
                                <div>
                                    ...
                                    <a href="#" class="block mt-2 text-xl font-semibold text-gray-800 transition-colors duration-300 transform dark:text-white hover:text-gray-600 hover:underline" tabindex="0" role="link">{{$article->title}}</a>
                                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">{{$article->summary}}</p>
                                </div>

                                <div class="mt-4">
                                    <div class="flex items-center">
                                        <div class="flex items-center">
                                            <img class="object-cover h-10 rounded-full" src="{{asset('storage/'.$article->author->avatar)}}" alt="Avatar">
                                            <a href="#" class="mx-2 font-semibold text-gray-700 dark:text-gray-200" tabindex="0" role="link">{{$article->author->name}}</a>
                                        </div>
                ...
                {{-- CONTENT 2 --}}
                <div class="grid w-full grid-cols-1 gap-4 mt-4 xl:grid-cols-2 2xl:grid-cols-3" style="border: green 1px solid;">
        ...
        <span class="flex items-center mr-1.5 text-sm text-green-500 dark:text-green-400">
          ...
          3,4%
                ...
                {{-- CONTENT 3 --}}
                <div class="grid grid-cols-1 my-4 xl:grid-cols-2 xl:gap-4" style="border: #0000cc 1px solid;">
