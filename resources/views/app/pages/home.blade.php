...
@section('content')
    <div class="p-4 bg-white block sm:flex items-center justify-between border-gray-200 lg:mt-1.5 dark:bg-gray-900 dark:border-gray-700">
        <div class="w-full mb-1 mb-4">
                ...
                <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                    ...
                    <li class="inline-flex items-center">
                        <a href="#" class="inline-flex items-center text-gray-700 hover:text-primary-600 dark:text-gray-300 dark:hover:text-white">
                            <svg class="w-6 h-6 mr-3 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
...
{{--                        <img class="object-cover w-full h-64" src="{{asset('storage/'.$article->featured_image_url)}}" alt="Article">--}}
                        ...
                        <div class="p-6">
                            <div>
                                ...
                                <a href="#" class="block mt-2 text-xl font-semibold text-gray-800 transition-colors duration-300 transform dark:text-white hover:text-gray-600 hover:underline" tabindex="0" role="link">
                                    {{$article->title}}
                                </a>
                            ...
                            <div class="mt-4">
                                <div class="flex items-center">
                                    <div class="flex items-center">
                                        <img class="w-6 h-6 mr-2 rounded-full" src="{{asset('storage/'.$article->author->avatar)}}" alt="Avatar">
                                        <a href="#" class="inline-flex items-center mr-3 text-sm font-semibold text-gray-900 dark:text-white" tabindex="0" role="link">{{$article->author->name}}</a>
                                    </div>
                                    <span class="mx-1 text-xs text-gray-600 dark:text-gray-300">{{date_format($article->author->last_acess, 'd/m/Y - H:m')}}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    {{-- CARD 2 QUESTIONARIOS --}}
                    <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">

                        {{-- TITLE/BUTTON POPOVE --}}
                        <h3 class="flex items-center mb-4 text-lg font-semibold text-gray-900 dark:text-white">Questionários
                        ...
                        {{-- TAB SELECT --}}
                        <div class="sm:hidden" style="border: red 2px solid;">
                        ...
                        <div class="flex items-center justify-between pt-3 mt-5 border-t border-gray-200 sm:pt-6 dark:border-gray-700">
                            ...
                            <div class="flex-shrink-0">
                                <a @click="expanded = ! expanded" href="#" class="inline-flex items-center p-2 text-xs font-medium uppercase rounded-lg text-primary-700 sm:text-sm hover:bg-gray-100 dark:text-primary-500 dark:hover:bg-gray-700">
                                    Full Report
                ...
                <h3 class="flex items-center mb-6 mt-6 ml-5 text-lg font-semibold text-gray-900 dark:text-white">Artigos recentes</h3>

                {{-- CONTENT 2 --}}
                <div class="grid w-full grid-cols-1 gap-4 mt-4 xl:grid-cols-2 2xl:grid-cols-3 mb-6">
                    @foreach($articles as $article)
                        <div class="lg:flex">
                            <img class="object-cover w-full h-56 rounded-lg lg:w-64" src="{{asset('storage/'.$article->featured_image_url)}}" alt="">

                            <div class="flex flex-col justify-between py-6 lg:mx-6">
                                <a href="#" class="text-md font-semibold text-gray-800 hover:underline dark:text-white">
                                    {{$article->subTitle}}
                                </a>

                                <span class="text-sm text-gray-500 dark:text-gray-300">{{date_format($article->author->last_acess, 'd/m/Y')}}</span>
                            </div>
                        </div>
                    @endforeach
                </div>
                ...
                {{-- CONTENT 3 --}}
                <div class="grid grid-cols-1 my-4 xl:grid-cols-2 xl:gap-4 mt-6" style="border: #0000cc 1px solid;">
                                ...
                                <footer class="flex items-center justify-between mb-2">
                                    <div class="flex items-center">
                                        <p class="inline-flex items-center mr-3 text-sm font-semibold text-gray-900 dark:text-white">
                                            <img class="w-6 h-6 mr-2 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-2.jpg"alt="Michael Gough">Michael Gough</p>
          ...
          <svg class="w-5 h-5 ml-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <span class="flex items-center mr-1.5 text-sm text-red-600 dark:text-red-500">
              ...
              0,6%
                ...
                {{-- CONTENT 4 --}}
                <div class="grid grid-cols-1 my-4 xl:grid-cols-2 xl:gap-4" style="border: #5b21b6 1px solid;">
                    <!-- Activity Card -->
              ...
              <span class="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200">
                ...
                {{-- CONTENT 5 --}}
                <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800" style="border: #00bb00 1px solid;">
                    <!-- Card header -->
