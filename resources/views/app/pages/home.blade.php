                    ...
                    <div class="grid gap-4 xl:grid-cols-2 2xl:grid-cols-3">
                        ...
                        <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                            ...
                            <div id="main-chart">
                                ...
                                <div x-data="{selectImageUrl: 'https://deep-image.ai/blog/content/images/2022/09/underwater-magic-world-8tyxt9yz.jpeg',
                                show: expanded
                                }">
                                    <img class="w-96 h-96" :class="show ? 'h-auto max-w-full rounded-lg':'hidden'" :src="selectImageUrl" alt="">
                                </div>
