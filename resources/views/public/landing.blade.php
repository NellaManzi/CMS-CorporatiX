...
<body>
        ...
        <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-900">
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                ...
                <div class="flex items-center lg:order-2">
                    @if (Route::has('login'))
                        @auth
                            <a href="{{ route('app.home') }}" class="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">Minha conta</a>
                            <a href="{{ route('filament.admin.pages.dashboard') }}" class="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">Get administration</a>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="grid py-8 px-4 mx-auto max-w-screen-xl lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            ...
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                <img src="{{asset('storage/' . $setting->header_logo_url)}}" alt="{{$setting->header_name}}">
            </div>
        </div>
    </section>
    ...
    <section class="bg-gray-100 py-8 dark:bg-gray-800">
        <div class="container mx-auto px-2 pt-4 pb-12 text-gray-800">
            ...
            <p class="mb-3 text-lg text-center font-normal text-gray-500 sm:text-xl dark:text-gray-400">
            ...
            <div class="grid gap-12 xl:grid-cols-6 xl:gap-24">
                <div class="col-span-2">
                    <a href="#" class="flex mr-4">
                        <img src="{{asset('storage/' . $setting->head_icon)}}" class="h-8 mr-3" alt="{{$setting->header_name}}" />
                        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">{{$setting->header_name}}</span>
                    </a>
                    <p class="max-w-lg mt-4 text-gray-500 dark:text-gray-400">{{$setting->header_description}}</p>

                    <div class="flex space-x-6 sm:justify-between mt-6">
