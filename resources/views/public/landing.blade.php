...
<body>
    ...
    <footer class="py-12 bg-white xl:py-24 dark:bg-gray-800">
        <div class="container px-4 mx-auto xl:px-0">
            ...
            <span class="block text-center text-gray-600 dark:text-gray-400">© 2023-<span id="currentYear">{{ date('Y')}}</span> <a href="https://flowbite.com" target="_blank" rel="noreferrer">Flowbite</a>. All Rights Reserved.</span>
        </div>
    </footer>
